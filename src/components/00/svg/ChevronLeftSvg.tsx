const ChevronLeftSvg = (): JSX.Element => {

  return (
      <svg height="32px" width="32px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 185.343 185.343"
           xmlSpace="preserve" fill="#FFFFFF" stroke="#FFFFFF" transform="matrix(-1, 0, 0, 1, 0, 0)">
